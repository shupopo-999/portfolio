    ...
    <div className="container text-center">
      ...
      <div>
        ...
        <div>
          ...
          <p>
          現在会社では、Windows Serverの構築をメインとしてその他に設計、構築、資料作成、動作確認などの業務に携わっています。 <br/>
          初の案件では、AWSのサーバー構築をメインで設計から構築までを担当し、クラウドの知識があるのが私しかいなかったため、<br/>
          チーム内での技術的なリーダーシップを発揮していました。<br/>
